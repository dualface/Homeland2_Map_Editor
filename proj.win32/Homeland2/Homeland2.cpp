    ...
    int       nCmdShow)
{
    ...
    return Homeland2::createAndRun();
}

int Homeland2::createAndRun(void)
{
    Homeland2 *host = Homeland2::sharedInstance();
    int ret = host->run();
    Homeland2::purgeSharedInstance();
    return ret;
}

Homeland2 *Homeland2::s_sharedInstance = NULL;

Homeland2 *Homeland2::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new Homeland2();
    }
    return s_sharedInstance;
}

void Homeland2::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
void Homeland2::loadProjectConfig(void)
{
    int index = 1;
    while (index < __argc)
    {
...
void Homeland2::updateWindowTitle(void)
{
}

void Homeland2::relaunch(void)
{
    RECT rect;
...
// menu callback
void Homeland2::onFileNewProject(void)
{
}

void Homeland2::onFileOpenProject(void)
{
...
void Homeland2::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres)) 
    {
        ...
        psl->SetDescription(L"Homeland2"); 
...
void Homeland2::onFileProjectConfig(void)
{
...
void Homeland2::onFileRelaunch(void)
{
    relaunch();
}

void Homeland2::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void Homeland2::onViewChangeFrameSize(int index)
{
    int w, h;
...
void Homeland2::onViewChangeDirection(int directionMode)
{
...
void Homeland2::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void Homeland2::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT Homeland2::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    Homeland2 *host = Homeland2::sharedInstance();
...
INT_PTR CALLBACK Homeland2::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
const string Homeland2::getCommandLineArg(int index)
{
    static string empty;
